...
export class GameOverMenu {
  ...
  init() {
    ...
    // Create semi-transparent dark red overlay plane
    const overlayGeometry = new THREE.PlaneGeometry(20, 20);
    const overlayMaterial = new THREE.MeshBasicMaterial({
      color: 0x330000,  // Dark red tint for game over
      transparent: true,
      opacity: 0.6,
    ...
    // Create buttons
    this.createButton('Try Again', 0, { action: 'retry' });
  ...
  createTitle() {
    ...
    // Draw "GAME OVER" text with red glow
  ...
  createButton(text, yOffset, userData) {
    ...
    const material = new THREE.MeshStandardMaterial({
      color: 0xcc4444,      // Reddish button color
      emissive: 0x882222,   // Red emissive
